                    ...
                    if counter < 4:  # Пока не получим 4 пакета (но не менее 500 мс от начала предъявления)
                        ...
                        for i in range(4):
                            for j in range(16):
                                ...
                                v1 += valuechannel1[i][j]
                                learnData += valuechannel2[i][j]
                                v2 += valuechannel2[i][j]
                                learnData += valuechannel3[i][j]
                                v3 += valuechannel3[i][j]
                        #print "__________________"
                        #print learnData
                        #print "__________________"


                        # write_pack_fifo_buf(learnData)
                        # нужно 3 списка передать valuechannel: 1 2 3
                        write_pack_fifo_buf(v1, v2, v3)
...
def write_pack_fifo_buf(arr1, arr2, arr3):
    s = ""
